    ...
    public partial class ajax : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (type == "getIsRun")
                {
                    if (dt >= DateTime.Parse("2018/11/3 22:33:00"))
                    {
                ...
                {
                    if (Request["userpwd"].ToString() == pwd)
                        Response.Write("登录成功");
                ...
                else if (type == "getCustLoginStatus") {
                    Response.Write("{\"result\":{\"statu\":\"true\"},\"user\":{\"CustName\":\"测试\",\"ftype\":\"1\", \"froomno\":\"\", \"fstatus\":\"0\"}}");
                    Response.End();
                }
